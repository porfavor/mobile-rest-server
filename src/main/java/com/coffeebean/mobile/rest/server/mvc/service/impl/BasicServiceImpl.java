...
public class BasicServiceImpl implements BasicService {
	...
	public <T extends PrimaryId> void deleteDomain(T domain) {
		...
		String table = BizUtils.underscoreName(StringUtils.uncapitalize(domain.getClass().getSimpleName()));
	...
	@Override
	public <T> T selectDomainLink(T link,Class<T> clz, String... primaryKeyField) {
	...
	public <T> void updateDomainLink(T link, String primaryKeyField) {
		String sql = new DslSql(link).update(primaryKeyField).where(primaryKeyField).toSql();
